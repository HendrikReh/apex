...
mod tests {
    ...
    fn any_embedder_from_config_selects_mock() {
        let config = AppConfig {
            ...
            oidc_platform_operator_groups: vec![],
            bootstrap_platform_api_key: None,
            rate_limit_global_rps: 1000,
            rate_limit_global_burst: 200,
            rate_limit_global_concurrency: 100,
            rate_limit_tenant_rps: 100,
            rate_limit_tenant_burst: 50,
            rate_limit_search_rps: 50,
            rate_limit_chat_rps: 20,
            rate_limit_ingest_concurrency: 10,
            rrf_k: 60,
            dense_top_k: 20,
            sparse_top_k: 20,
